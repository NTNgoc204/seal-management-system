...
This project is indexed by GitNexus as **seal-management-system** (694 symbols, 805 relationships, 9 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
