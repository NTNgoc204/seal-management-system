...
This project is indexed by GitNexus as **seal-management-system** (200 symbols, 197 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
